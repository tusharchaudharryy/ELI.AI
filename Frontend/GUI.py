from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QStackedWidget, QWidget, QLineEdit, QGridLayout, QVBoxLayout, QHBoxLayout, QPushButton, QFrame, QLabel, QSizePolicy, QTextEdit
...
class ChatSection(QWidget):
    def __init__(self):
        ...
        self.label = QLabel("")
        self.label.setStyleSheet("color: white; font-size:16px; margin-right: 195px; border: none; margin-top: 10px;")
